...
export default class SseEditor3d extends React.Component {
    ...
    componentDidMount() {
        ...
        this.onMsg("pagedown", () => {
            ...
            // <Link to={{pathname:window.global[i].editUrl,state:{imageUrl:this.props.imageUrl,global:window.global}}}></Link> 
        ...
        this.onMsg("view-spin", () => this.cameraPreset("spin"));
    ...
    */
    ...
    computeOriginalBox(forEachableIndices) {
        let geom;
        let flat = [];
        forEachableIndices.forEach(pto => {
            const p = this.cloudData[pto];
        ...
        geom = new THREE.BufferGeometry();
        let vertices = new Float32Array(flat);
        geom.addAttribute('position', new THREE.BufferAttribute(vertices, 3));
        geom.computeBoundingBox();
